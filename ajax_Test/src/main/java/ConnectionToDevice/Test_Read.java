...
public class Test_Read {
    ...
    public synchronized Map<String,List<Device>> CheckValues(HashMap map, TCPMasterConnection con)  {
        ...
        while (iterator.hasNext()) {
            ...
            ReadMultipleRegistersResponse response = getResponse(con, key, String.valueOf(entry.getValue()));
    ...
    private ReadMultipleRegistersResponse getResponse(TCPMasterConnection con,String key,String value){
